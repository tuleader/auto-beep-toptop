...
Bạn được phép dùng Phần mềm cho các mục đích hợp pháp: chăm sóc, tương tác và tiếp thị trên các tài khoản TikTok của mình, tuân thủ pháp luật Việt Nam và điều khoản của nền tảng.

**NGHIÊM CẤM dùng Phần mềm để:**
...
Bạn chịu hoàn toàn trách nhiệm trước pháp luật về nội dung bạn tạo ra và cách bạn dùng Phần mềm. Tác giả không kiểm soát, không kiểm duyệt và không chịu trách nhiệm về nội dung bình luận do bạn cung cấp.

## 4. Dữ liệu cá nhân và quyền riêng tư
...
## 5. Tài nguyên và dịch vụ bên thứ ba
...
## 7. Không bảo hành; giới hạn trách nhiệm
...
## 8. Hỗ trợ, đóng góp và hoàn tiền
...
Điều khoản này được soạn theo các văn bản đang có hiệu lực tại thời điểm ban hành:
...
Khi văn bản nêu trên được thay thế hoặc sửa đổi, điều khoản này được hiểu theo văn bản mới tương ứng cho tới khi được cập nhật.

## 13. Đồng ý

Bằng cách nhấn "Đồng ý", bạn xác nhận đã đọc, hiểu và chấp thuận toàn bộ điều khoản trên, và xác nhận đáp ứng điều kiện ở mục 2. Nếu không đồng ý, hãy nhấn "Không đồng ý" — Phần mềm sẽ đóng lại.
...
- Hỗ trợ và hướng dẫn sử dụng: https://www.facebook.com/100017717225379
- Trang tải và điều khoản công khai: https://github.com/tuleader/auto-beep-toptop
